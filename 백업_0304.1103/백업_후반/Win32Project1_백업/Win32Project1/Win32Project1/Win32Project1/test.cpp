...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		CreateToolTip(IDC_MAIN_EDIT, hWnd, TEXT("주소 입력창")); //툴팁 생성
		...
		search_button = CreateWindow(TEXT("BUTTON"), NULL, WS_VISIBLE | WS_CHILD | BS_BITMAP, 480, 0, 30, 30, hWnd, (HMENU)IDC_MAIN_BUTTON, NULL, NULL);
		CreateToolTip(IDC_MAIN_BUTTON, hWnd, TEXT("이동")); //툴팁 생성
		...
		back_button = CreateWindow(TEXT("BUTTON"), NULL, WS_CHILD | WS_VISIBLE |  BS_BITMAP, 0, 0, 30, 30, hWnd, (HMENU)BACK_BUTTON,g_hInst, NULL);
		CreateToolTip(BACK_BUTTON, hWnd, TEXT("이전 페이지로 이동")); //툴팁 생성
		...
		CreateToolTip(FRONT_BUTTON, hWnd, TEXT("다음 페이지로 이동")); //툴팁 생성
		...
		/*새로고침*/
		refresh_button = CreateWindow(TEXT("BUTTON"), NULL, WS_VISIBLE | WS_CHILD | BS_BITMAP , 60, 0, 30, 30, hWnd, (HMENU)REFRESH_BUTTON, g_hInst, NULL);
		CreateToolTip(REFRESH_BUTTON, hWnd, TEXT("새로고침")); //툴팁 생성
		...
		CreateToolTip(HOME_BUTTON, hWnd, TEXT("홈으로 이동")); //툴팁 생성
		...
		line_button = CreateWindow(TEXT("BUTTON"), NULL, WS_VISIBLE | WS_CHILD | BS_BITMAP, 0, 30, 1900, 2, hWnd, (HMENU)LINE_BUTTON, NULL, NULL);
	...
	case WM_COMMAND:
		...
		case ID_VISITLOG: //방문기록 보기
			...
			if (result_visit_log != -1) {
				visit_log_delete_button = CreateWindow(TEXT("BUTTON"), TEXT("방문기록삭제"), WS_VISIBLE | WS_CHILD | BS_BITMAP, 180, 88, 150, 20, hWnd, (HMENU)VISIT_LOG_DELETE_BUTTON, NULL, NULL);
	...
	case WM_PAINT: //사용자로부터 입력받은 것을 화면에 뿌려줌
		...
		rt = { 49-xPos,90-yPos,1024,768 }; //for문 안돌려도 된다.
